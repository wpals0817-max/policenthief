  ...
  return (
    <main className="min-h-screen p-4 safe-area-top safe-area-bottom bg-gray-50">
      ...
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900 ml-2">내 프로필</h1>
      </div>
      ...
      <Card variant="default" padding="lg" className="mb-6">
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900">{userName || "플레이어"}</h2>
          <p className="text-gray-600 text-sm mt-1">{playerStyle}</p>
        </div>
      </Card>
      ...
      <Card variant="default" padding="lg" className="mb-4">
        ...
        <div className="grid grid-cols-3 gap-4 text-center mb-6">
          <div>
            ...
            <p className="text-gray-600 text-sm">총 게임</p>
          </div>
          <div>
            <p className="text-3xl font-bold text-green-600">{wins}</p>
            <p className="text-gray-600 text-sm">승리</p>
          </div>
          <div>
            <p className="text-3xl font-bold text-red-600">{loses}</p>
            <p className="text-gray-600 text-sm">패배</p>
          </div>
        </div>
        ...
        <div className="mb-6">
          <div className="flex justify-between text-sm mb-2">
            <span className="text-gray-600">전체 승률</span>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
            <p className="text-gray-600 text-sm mb-1">총 이동 거리</p>
            <p className="text-xl font-bold text-blue-600">{formatDistance(totalDistance)}</p>
          </div>
          <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
            <p className="text-gray-600 text-sm mb-1">총 플레이 시간</p>
            <p className="text-xl font-bold text-yellow-600">{Math.round(totalDuration / 60)}분</p>
          </div>
          <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
            <p className="text-gray-600 text-sm mb-1">총 체포 수</p>
            <p className="text-xl font-bold text-police-600">{totalCatches}</p>
          </div>
          <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
            <p className="text-gray-600 text-sm mb-1">총 구출 수</p>
      ...
      {/* 포지션별 통계 */}
      <Card variant="default" padding="lg" className="mb-4">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">🎭 포지션별 통계</h2>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Card variant="police" padding="md">
            <div className="text-center">
              ...
              <p className="text-police-700 font-medium">경찰</p>
              <p className="text-2xl font-bold text-gray-900 mt-2">{policeGames.length}게임</p>
              <p className="text-sm text-police-600">
          ...
          <Card variant="thief" padding="md">
            <div className="text-center">
              <div className="text-3xl mb-2">🏃</div>
              <p className="text-thief-700 font-medium">도둑</p>
              <p className="text-2xl font-bold text-gray-900 mt-2">{thiefGames.length}게임</p>
              <p className="text-sm text-thief-600">
      ...
      {/* 최근 게임 히스토리 */}
      <Card variant="default" padding="lg" className="mb-4">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">📜 최근 게임</h2>

        {gameHistory.length === 0 ? (
          <p className="text-gray-600 text-center py-8">아직 플레이한 게임이 없습니다</p>
        ) : (
              ...
              >
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-gray-900 font-medium">{game.roomName}</p>
